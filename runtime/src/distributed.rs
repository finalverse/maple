...
pub struct DistributedNode {
    ...
    running: bool,
    agents: AgentRegistry, // Added agents registry
}
...
impl DistributedNode {
    pub async fn new() -> Self {
        ...
        agents.register("agent1".to_string(), agent::SimpleAgent); // Register default agents
    ...
    pub async fn send_ual(&mut self, stmt: UALStatement) -> Result<(), String> {
        let msg = create_map_message(stmt, "runtime");
